      ...
      this.state.news.reverse().map((item, i) => (
        ...
        <li key={i} className="row">
          ...
          <div className="col-lg-4 col-sm-4 col-md-4 col-xs-4">
            <div className="date">
              <h3><span id="er" >{item.month}</span><br /><span className="row" id="lis">{item.date}</span></h3>
            </div>
          </div>
            ...
            <div className="row row-30">
              ...
              <div className="col-lg-6 col-12">
                <div className="block-sm offset-top-45">
                  <div className="section-name wow fadeInRight" data-wow-delay=".2s" style={{ color: "#454545" }}>About us</div>
                  ...
                  <p className="default-letter-spacing font-weight-bold text-gray-dark wow fadeInUp" data-wow-delay=".4s">We are conducting several events every year for the betterment of students.</p><a className="button-width-190 button-primary button-circle button-lg button offset-top-30" href="/member">VIEW OUR TEAM</a>
                </div>
              </div>
            </div>
          </div>
