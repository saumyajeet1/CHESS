...
class Blog extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      placement.
      `,
      main1:` Two rounds were conducted: Online Aptitude Test and Personal Interview. As I was preparing for CAT exams,
so didn't need any extra preparation. However, I highly recommend that you all practice aptitude from online websites like
IndiaBix. 
      `,
      main2:`There was around 80 questions plus a separate section to solve pseudo codes. Overall level of difficulty is 4/5.
...
Level of difficulty is 4/5. `,main1:` Mostly they ask questions from your training/intern and from your favorite subjects. In HR round
...
explain in the simplest manner with technical terms when asked.,`,main2:` Prepare your favorite subjects properly. They also check
...
namely, pen and paper test, technical interview and HR interview. For the online round, I prepared basics of chemical core`,main1:`
...
online round. The level of difficulty for which was 4/5.  The technical questions I faced in PI round were to design Heat`,main2:`
...
basics of chemical core subjects. Some of the HR questions that I faced in the PI round were to give a solution to a tricky`,main3:`
...
matters. Some tips to juniors to prepare for this particular companies interview is that no need to mug up chemical`,main4:` 
engineering subjects, you should have a clear basic idea about core chemical, go through the basic phenomena of fluid
mechanics, heat exchanger, mass transfer specially.`,main5:` Be confident about what you are saying because they diverts your
...
process was conducted in three rounds: Aptitude, technical and HR.`,main1:` I practiced aptitude from Indiabix and Pariksha. For
coding I followed geekforgeeks and some youtube videos.There were different sections in aptitude round, guesstimate was
one of them. Overall level of difficulty for apti round is 4/5 .`,main2:` There was no GD round. However it will be wise to be aware
...
questions but very few. It was just a formality.`,main3:`  PI round was overall 4/5 . I was offered the offer letter there only along with
...
less. Practice typing on keyboard. `,main4:`During the online round, 30 mins will be given to you and you will be told to write an
essay and a guesstimate, both of minimum 350 words. So you need to be very fast. Most of my friends were unable to
complete the essay and the guesstimate part. I completed both on time.`,main5:` For the technical round, i would suggest you guys
...
profitable one. Be vigilant about current topics and practice how to summarize your points. In the PI round they asked`,main2:`
...
2-For technical part ,as I was preparing for GATE so everything came under it..`,main1:`
Around 70 to 80 questions in 1 hour were asked in the online round, the level of difficulty being 3/5. The technical
questions I faced in PI round were mostly practical based.`,main2:` I did not take much preparation for the technical PI
...
· HR interview final round.`,main1:`
...
was 4/5. The type of technical questions I faced in PI round were:`,main2:`
· Moderate.
· Subject related.
· Current semester related.
· Training related.
· Basic practical application.`,main3:`
...
· Be confident, not arrogant.`,main5:`
...
semesters.The HR questions I faced in the PI round were:`,main4:`
1. Tell me about yourself
2. Extracurricular activities
3. Why should we select you over others?
4. Weakness
5. What will you do if your subordinates don't abide by your instructions?`,main5:`
...
answering the HR questions but don't lie to them as they are much experienced than you.`,main6:`
...
glassdoor.com that what kind of questions they generally ask, and then I prepare accordingly. There were`,main1:`
...
happen. Linde's GD topics are mostly on trending and common issues.`,main2:`
...
equipment, their working principles and most importantly thermodynamic processes and cycles. In the HR`,main3:`
...
(process/sales), any location problem, interested in doing MBA or not and why (never say NO, try to give`,main4:`
...
Non verbal Reasoning. 100 questions were asked in the online round, the level of difficulty for which was 3/5.`,main1:`
...
questions are repeated, so if you are a gate aspirant and preparing for it, it will definitely provide you an upper`,main1:`
...
came for recruitment for 2 different positions for our batch- for RPMG and for Operations. So the very first`,main2:`
...
crucial round. Around 45 students sat for the online test and only 10 were shortlisted hat I was asked in my PI`,main3:`
...
types and utilities). They were not exactly direct questions rather application based so make sure you have`,main4:`
...
sulphur removal from crude petroleum. Then I was asked, if electric cars completely take over the market,`,main5:`
...
small problems could be asked to solve, so I went through the important formulas. I read about my projects`,main6:`
...
asked me to name five companies from the Fortune 500 list. Then they asked about my takeaways from IOCL`,main7:`
...
and work towards improving that. Besides I got to know alot about Reliance Industries and the various perks`,main2:`
...
for which was 3/5. The technical questions I faced in the PI round, were mostly related to the Project and`,main2:`
vocational training. For the technical PI round, I thoroughly read my project and the units covered in my
vocational training. The HR questions I faced in the PI round were based on:`,main3:`
· Strengths and weaknesses
· How hard working are you?
· Family background
· Future plans
· Further studies`,main4:`
...
difficulty was 3/5. In the GD round we have to solve one case study. In the technical questions they asked from`,main1:`
...
channels like chemicalpedia. In the HR round they asked me about my weakness(es). Level of difficulty of PI was`,main2:`
...
chemical notes. In the online test we have to solve 30 apti questions in 30 min and 50 technical questions in 30`,main1:`
...
all the process flow diagrams of different units I had visited during my training.`,main2:` I had prepared my own notes of
heat and mass transfer. For Fluid mechanics and CRE I revised the whole notes given by PPG Sir. In the HR
round they asked about why I want to join reliance, what are my strengths and weaknesses, my long term goal`,main3:`
...
website and gate aptitude questions.60 aptitude question for 1 hour and 30 technical questions for half an hour`,main2:`
...
English language only. The Technical PI round questions I faced was based on favorite subject that you have,`,main3:`
...
technical round was : Studied the favorite subjects, second year projects and third year training reports very well`,main4:`
...
and asked how to react in that condition. My takeaway from the interview is : Focus on basics of everything...`,main5:`
...
`,
main:`Hi Disha here. Selection Rounds were : Online aptitude round,GD round,Case study round,Technical PI,HR PI.
...
need to be aware of current issues going around oneself. In technical PI round , Mostly questions about my,`,main1:`
...
join the company, why that job role,why that location and job sector. Takeway from the interview - “If I don't`,main2:`
...
but Be aware with the current topics and have a good communication skills. In my technical interview , they`,main1:`
asked mainly from Mass Transfer.
HR Round Questions :
1.Tell me about yourself
2.your family background
3.strength and weakness
4.Have you solve any complex problem?`,main2:`
...
9.Do you want to do Higher studies?`,main3:`
...
the analogies (Reynold, Prandtl, Coulborn), What happens to head and flow rate if pumps are in series and`,main1:`
...
allow you?, What makes you angry?, where do you like to see yourself after 5 years?, Define management. My`,main2:`
...
Fortunately or unfortunately I got RPMG panel of RIL. They ask numerous technical questions focusing mainly,`,main1:`
...
disadvantages in distillation column etc. They also ask questions to test our presence of mind and our`,main2:`
...
My Preparation for Technical round : Follow the class notes even if it is basic it will be easy to answer questions`,main3:`
...
question perfectly. A form will be provided by RIL which should be filled before PI. Fill the CV and form in such`,main4:`
...
control of mind and hope in interview.`,main5:`
