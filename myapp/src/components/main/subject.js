...
const Subject = () => {
    return (
        ...
        <div id="smallbox" style={{backgroundColor:'#123C69'}}>
         ...
         <div id="boxheading2" style={{color:"#EDC787"}}><a style={{color:"#EDC787"}} href="https://drive.google.com/open?id=1iZP0fLS3pgOumPUaZm3XyOb1AFatq6O_" style={{color:"#EDC787"}}>Process Calculations</a></div>
         <div id="boxheading3" style={{color:"#EDC787"}}>B.tech</div>
...
{/*        
       ...
       <div id="smallbox" style={{backgroundColor:'#123C69'}}>
         <div id="boxheading1" style={{color:"#EDC787"}}>PRP</div>
         <div id="boxheading2" style={{color:"#EDC787"}}><a style={{color:"#EDC787"}} href="" style={{fontSize:'6px'}}>Petroleum Refining and Petrochemicals</a></div>
         <div id="boxheading3" style={{color:"#EDC787"}}>B.tech</div>
         <div id="boxheading3" style={{color:"#EDC787"}}>6th sem</div>
       </div>
       ...
       <div id="smallbox" style={{backgroundColor:'#123C69'}}>
         <div id="boxheading1" style={{color:"#EDC787"}}>EMA</div>
         <div id="boxheading2" style={{color:"#EDC787"}}><a style={{color:"#EDC787"}} href="" style={{fontSize:'8px'}}>Economics and Management Accounting</a></div>
         <div id="boxheading3" style={{color:"#EDC787"}}>B.tech</div>
         <div id="boxheading3" style={{color:"#EDC787"}}>6th sem</div>
       </div>
